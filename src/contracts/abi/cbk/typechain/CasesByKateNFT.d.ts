...
interface CasesByKateNFTInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setOnChainDataContract(address)": FunctionFragment;
    ...
    "onChainDataContract()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setOnChainDataContract",
    values: [string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "onChainDataContract",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class CasesByKateNFT extends Contract {
  ...
  interface: CasesByKateNFTInterface;
  ...
  functions: {
    ...
    setOnChainDataContract(
      addr: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "setOnChainDataContract(address)"(
      addr: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;
    ...
    onChainDataContract(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    onChainDataContract(overrides?: CallOverrides): Promise<BigNumber>;
