...
interface CryptoCriminals77Interface extends ethers.utils.Interface {
  functions: {
...
export class CryptoCriminals77 extends Contract {
  ...
  interface: CryptoCriminals77Interface;
